...
import { LayoutDashboard, ShoppingCart, History, LogOut, Plus, Minus, Trash2, MonitorPlay, Printer, Layers, FileText, Image, Download, Monitor, Code, Settings, Menu, MessageCircle } from 'lucide-react';
...
export default function Admin() {
  ...
  const sendWhatsAppBill = () => {
    ...
    // Number formatting (strip leading 0 if user enters it for Sri Lankan numbers)
